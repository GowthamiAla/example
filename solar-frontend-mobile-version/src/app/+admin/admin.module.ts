...
//import { NotificationChannelsComponent } from '../+notifications/+notifications-channels/notifications-channels.component'
...
@NgModule({
  ...
  imports: [
    ...
    routing,
    ChartModule, TreeViewModule, FormsModule, ReactiveFormsModule
  ],
