...
export class NotificationsTreeComponent implements OnInit {
    ...
    public notificationChannel = new NotificationModel(null, this.serviceEvent, true, false, true, this.emailTemplate, this.notificationTemplate, this.userRolesArray);
