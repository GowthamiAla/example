...
export class OtpComponent implements OnInit {
  ...
  constructor(private alertNotificationService: AlertNotificationService,private route: ActivatedRoute,private router: Router, private authService: AuthService, private fb: FormBuilder) {
   ...
   MatchPassword(control: FormControl) {
       ...
       let confirmPassword = control.get('retypePassword').value;
