...
export class ReportService {
    ...
    */
    ...
    public addReport(reportTemplateName, reportTemplateFormat, report: any) {
        ...
        this.headers.append("Authorization", localStorage.getItem('Authentication'));
        // this.headers.append("Content-Type", "application/json");
        return this.http.post(endponitConfig.REPORT_ENDPOINT + reportTemplateName + '/' + reportTemplateFormat, report, { headers: this.headers })
    ...
    */
    public updateReport(reportData: any) {
        let reportName = reportData.templateName;
        let reportType = reportData.formatType;
        this.headers = new Headers();
        this.headers.append("Authorization", localStorage.getItem('Authentication'));
        // this.headers.append("Content-Type", "application/json");
        return this.http.post(endponitConfig.REPORT_ENDPOINT + reportName + '/' + reportType, reportData, { headers: this.headers })
            .map(res => { return res.json() }).catch(this.handleError);
    }
    ...
    public getAllReports() {
        ...
        this.headers.append("Authorization", localStorage.getItem('Authentication'));
        this.headers.append("Content-Type", "application/json");
        return this.http.get(endponitConfig.REPORT_ENDPOINT, { headers: this.headers }).map((responce: Response) => responce.json().data).catch(this.handleError)
    }

    /**
    * This method gets Report details based on report Id
    */
    public getReportByID(reportId: number) {
        this.headers = new Headers();
        this.headers.append("Authorization", localStorage.getItem('Authentication'));
        this.headers.append("Content-Type", "application/json");
        return this.getAllReports().toPromise().then(reports => reports.find(reportA => Number(reportA.id) === Number(reportId))).catch(this.handleError);
    }
...
//     // this.reportsHeaders.append("Authorization", "Basic " + localStorage.getItem('Authentication'));
...
//     this.headers.append("Authorization", "Basic " + localStorage.getItem('Authentication'));
//     this.headers.append("Content-Type", "application/json");
//     return this.http.post(endponitConfig.REPORT_ENDPOINT + 'userreport/' + reportTemplateName + '/' + reportTemplateFormat, report, { headers: this.reportsHeaders })
//       .map(res => { return res.json() }).catch(this.handleError);
//   }
...
//     this.headers.append("Authorization", "Basic " + localStorage.getItem('Authentication'));
//     this.headers.append("Content-Type", "application/json");
//     return this.http.delete(endponitConfig.REPORT_ENDPOINT + 'userreport/' + reportId, { headers: this.headers })
//       .map(res => { return res.json() }).catch(this.handleError);
//   }
