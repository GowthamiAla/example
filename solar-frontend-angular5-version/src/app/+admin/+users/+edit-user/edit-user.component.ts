...
@Component({
  ...
  providers: [ActivitiesComponent, Global, NotificationService]
...
export class EditUserComponent implements OnInit {
  ...
  constructor(private activitiesComponent: ActivitiesComponent, private alertNotificationService: NotificationService,
